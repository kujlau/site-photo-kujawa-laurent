  ...
  return (
    <div className='container'>
      <div className="back_couple">
        ...
        <img className='img1' src={image_1} alt=""></img>
        <img className='img2' src={image_2} alt=""></img>
        <img className='img3' src={image_3} alt=""></img>
        <img className='img4' src={image_4} alt=""></img>
        <img className='img5' src={image_5} alt=""></img>
        <img className='img6' src={image_6} alt=""></img>
        <img className='img7' src={image_7} alt=""></img>
        <img className='img8' src={image_8} alt=""></img>
        <img className='img9' src={image_9} alt=""></img>
        <img className='img10' src={image_10} alt=""></img>
        <img className='img11' src={image_11} alt=""></img>
        <img className='img12' src={image_12} alt=""></img>
        <Link className="retour" to="/galerie"><h2>RETOUR A LA GALERIE</h2></Link>
        <Footer />
